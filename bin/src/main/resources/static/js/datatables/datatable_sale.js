...
$(document).ready(function() {
	...
	tablaProductos = $('#dataTableSale').DataTable({
		...
		buttons: [
			{
				extend: "excelHtml5", filename: `TablaFacturas-${jsDate}`, text: "Excel", titleAttr: "Exportar Excel", className: "btn btn-success px-3 mr-2 rounded",
				messageTop: `Registro de Facturas`,
				exportOptions: {
					columns: [1, 2, 3, 4, 5, 6]
			...
			{
				extend: "pdfHtml5", filename: `TablaFacturas-${jsDate}`, text: "PDF", titleAttr: "Exportar PDF", className: "btn btn-danger px-3 mr-2 rounded",
				exportOptions: {
					columns: [1, 2, 3, 4, 5, 6]
				...
				customize: function(doc) {
					...
					doc['header'] = (function() {
						return {
							columns: [
								{ alignment: 'center', italics: false, text: 'Registro de Facturas', color: "black", fontSize: 18, margin: [0, 10] },
							],
							margin: 20
						}
					});
			...
			{
				extend: "print", filename: "Facturas", text: "Imprimir", titleAttr: "Imprimir", className: "btn btn-dark px-2 mr-2 rounded",
				exportOptions: {
					columns: [1, 2, 3, 4, 5, 6]
				}
			}
