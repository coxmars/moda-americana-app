...
$(document).ready(function() {
	...
	tablaProductos = $('#dataTableUnitaryClothing').DataTable({
		...
		buttons: [
			{
				extend: "excelHtml5", filename: `TablaPrendasUnitarias-${jsDate}`, text: "Excel", titleAttr: "Exportar Excel", className: "btn btn-success px-3 mr-2 rounded",
				messageTop: `Registro de Prendas Unitarias`,
				exportOptions: {
			...
			{
				extend: "pdfHtml5", filename: `TablaPrendasUnitarias-${jsDate}`, text: "PDF", titleAttr: "Exportar PDF", className: "btn btn-danger px-3 mr-2 rounded",
				exportOptions: {
				...
				customize: function(doc) {
					...
					doc['header'] = (function() {
						return {
							columns: [
								{ alignment: 'center', italics: false, text: 'Registro de Prendas Unitarias', color: "black", fontSize: 18, margin: [0, 10] },
							],
							margin: 20
						}
					});
