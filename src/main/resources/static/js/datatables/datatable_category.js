...
$(document).ready(function() {
	...
	tablaProductos = $('#dataTableCategory').DataTable({
		...
		buttons: [
			{
				extend: "excelHtml5", filename: `TablaCategoríasProductos-${jsDate}`, text: "Excel", titleAttr: "Exportar Excel", className: "btn btn-success px-3 mr-2 rounded",
				messageTop: `Registro de Categorías de Productos`,
				exportOptions: {
					columns: [0, 1, 2, 3]
			...
			{
				extend: "pdfHtml5", filename: `TablaCategoríasProductos-${jsDate}`, text: "PDF", titleAttr: "Exportar PDF", className: "btn btn-danger px-3 mr-2 rounded",
				exportOptions: {
					columns: [0, 1, 2, 3]
				...
				customize: function(doc) {
					...
					doc['header'] = (function() {
						return {
							columns: [
								{ alignment: 'center', italics: false, text: 'Registro de Categorías de Productos', color: "black", fontSize: 18, margin: [0, 10] },
							],
							margin: 20
						}
					});
			...
			{
				extend: "print", filename: "Categorías de Productos", text: "Imprimir", titleAttr: "Imprimir", className: "btn btn-dark px-2 mr-2 rounded",
				exportOptions: {
					columns: [0, 1, 2, 3]
				}
			}
