...
$(document).ready(function() {
	...
	tablaProductos = $('#dataTableProvider').DataTable({
		...
		buttons: [
			{
				extend: "excelHtml5", filename: `TablaProveedores-${jsDate}`, text: "Excel", titleAttr: "Exportar Excel", className: "btn btn-success px-3 mr-2 rounded",
				messageTop: `Registro de Proveedores`,
				exportOptions: {
					columns: [1, 2, 3, 4]
			...
			{
				extend: "pdfHtml5", filename: `TablaProveedores-${jsDate}`, text: "PDF", titleAttr: "Exportar PDF", className: "btn btn-danger px-3 mr-2 rounded",
				exportOptions: {
					columns: [1, 2, 3, 4]
				...
				customize: function(doc) {
					...
					doc['header'] = (function() {
						return {
							columns: [
								{ alignment: 'center', italics: false, text: 'Registro de Proveedores', color: "black", fontSize: 18, margin: [0, 10] },
							],
							margin: 20
						}
					});
			...
			{
				extend: "print", filename: "Proveedores", text: "Imprimir", titleAttr: "Imprimir", className: "btn btn-dark px-2 mr-2 rounded",
				exportOptions: {
					columns: [1, 2, 3, 4]
				}
			}
